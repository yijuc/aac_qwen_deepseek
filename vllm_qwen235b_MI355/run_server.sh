...
server_log_dir="/mnt/nfs/RAID/shared/eveline/vllm_qwen235b/logs_0120_kunlun_profiler"
...
unset SAFETENSORS_FAST_GPU VLLM_ROCM_USE_AITER VLLM_ROCM_USE_AITER_MHA VLLM_ROCM_QUICK_REDUCE_QUANTIZATION
...
vllm serve ${MODEL} \
    ...
    --compilation-config '{\"custom_ops\": [\"-rms_norm\", \"-quant_fp8\"], \"cudagraph_mode\": \"FULL_AND_PIECEWISE\",  \"pass_config\": {\"enable_qk_norm_rope_fusion\": true}}' \
    --trust-remote-code \
